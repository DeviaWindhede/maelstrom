...
public:
	...
	POINT GetCurrentMousePositionPoint() const
	{
		return POINT(myCurrentMouseState.x, myCurrentMouseState.y);
	}

	DirectX::XMINT2 GetCurrentMousePositionVector2i() const
	{
		return DirectX::XMINT2(myCurrentMouseState.x, myCurrentMouseState.y);
	}

	DirectX::XMFLOAT2 GetCurrentMousePositionVector2f() const
	{
		return DirectX::XMFLOAT2((float)myCurrentMouseState.x, (float)myCurrentMouseState.y);
	}
